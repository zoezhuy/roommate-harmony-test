...
## 项目速览
- **项目类型**：AI 交互产品设计 / HCI 产品原型
- **核心场景**：室友匹配与合住前沟通
- **核心方法**：6 维加权 Likert 模型、0–100 匹配算法、Persona 映射
- **项目价值**：将主观匹配问题转化为可解释、可讨论的结构化反馈

## 项目简介
Roommate Harmony Test 是一个围绕“室友匹配”场景设计的 AI 交互产品原型，目标是帮助用户在合住前更早识别潜在生活摩擦点，并把原本难以启齿的现实问题，转化为更容易开始的结构化对话。
不同于传统基于兴趣或表面偏好的匹配方式，这个项目更关注真实共同生活中更容易引发冲突的因素，例如作息、清洁习惯、社交边界、噪音容忍度与沟通方式，并通过问卷、评分系统与 Persona 映射，提供更可解释的兼容性反馈。
...
## 项目成果
1. 完成从首页、问卷到结果页的完整交互流程设计
2. 通过前端原型验证产品流程与结果表达方式
3. 建立基于 6 维加权 Likert 模型的可解释评分系统
4. 实现 Persona 映射机制，将匹配结果转化为可讨论的结构化反馈
